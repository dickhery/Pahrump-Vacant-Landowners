...
import { idlFactory } from './godot_html5_assets.did.js';
export { idlFactory } from './godot_html5_assets.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_GODOT_HTML5_ASSETS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./godot_html5_assets.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the godot_html5_assets canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./godot_html5_assets.did.js")._SERVICE>}
 */
export const godot_html5_assets = createActor(canisterId);
